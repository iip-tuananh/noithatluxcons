...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    ...
    Route::get('bao-gia/{slug}.html','PageController@serviceDetail')->name('serviceDetail');
    Route::get('dich-vu-bao-gia.html','PageController@listService')->name('listService');
    ...
    Route::group(['prefix'=>'goc-tu-van'], function(){
