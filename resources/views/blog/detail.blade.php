...
<main id="w-cate" class="">
   <section id="banner-cate">
      <div class="avarta"><img src="{{$blog_detail->image}}" class="img-fluid" width="100%" alt="">
      </div>
   </section>
      ...
      <div class="container">
         <div class="content">
            <ul class="list-inline">
               ...
               <li class="list-inline-item"><a href="{{route('allListBlog')}}">Góc tư vấn</a></li>
               <li>
                  <i class="fa fa-angle-right"></i>
               </li>
                     ...
                     <div class="swiper-container slide-news swiper-container-horizontal">
                        <div class="swiper-wrapper" style="transition-duration: 300ms;">
                           ...
                           <div class="swiper-slide">
                              <div class="item" style="background-image: url({{url('frontend/images/bg_duan_home.jpg')}})">
